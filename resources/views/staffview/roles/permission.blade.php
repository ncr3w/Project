    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('roles.editpermission', ['id' => $roles->id]) }}" data-parsley-validate class="form-horizontal form-label-left"> 
                    	...
                    	<div class="form-group{{ $errors->has('permissions') ? ' has-error' : '' }}">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="permissions"> Permission {{ $roles->display_name }}
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
