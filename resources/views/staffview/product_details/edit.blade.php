                ...
                <div class="x_content">
                    ...
                    <form method="post" action="{{ route('brands.update', ['id' => $brands->id]) }}" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group{{ $errors->has('comment') ? ' has-error' : '' }}">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="comment"> Nama <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" value="{{ $product_detail->comment }}" id="comment" name="comment" class="form-control col-md-7 col-xs-12">
